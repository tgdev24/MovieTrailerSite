...
movie1 = movie.Movie('Avengers: Infinity War',
                     'Movie about superheroes and one giant purple villain',
                     'https://news.marvel.com/wp-content/uploads/2017/07/studios_post_master-960x540.jpg',
                     'https://www.youtube.com/watch?v=6ZfuNTqbHE8')
movie2 = movie.Movie('The New Mutants',
...
movie3 = movie.Movie('Ant Man and the Wasp',
                     'Movie about guy that turns into an ant',
                     'http://t2.gstatic.com/images?q=tbn:ANd9GcRxIQHv1T0L649pKR64-WOZpiWGKw5R7W7hkxK2Crl3EiQwZEja',
                     'https://www.youtube.com/watch?v=XyZERzqh090')
# put all movie objects created into a list
movies = [movie1, movie2, movie3]

fresh_tomatoes.open_movies_page(movies) # open_movies_page takes in a list of movie objects
